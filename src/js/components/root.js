  ...
  render() {
    ...
    return (
      <BrowserRouter>
        ...
        <HeaderBar/>
        <Route exact path="/~kindling" render={ () => {
          return (
            <Box height='100%' p='4' display='flex' flexDirection='column' borderWidth={['none', '1px']} borderStyle="solid" borderColor="washedGray">
              <Text fontSize='1'>Kindling</Text>
              <Text pt='3'>Test App for the Kindling App on Urbit</Text>
              <Text pt='3'>To get started, edit <code>src/index.js</code> or <code>urbit/app/kindling.hoon</code> and <code>|commit %home</code> on your Urbit ship to see your changes.</Text>
